...
interface CompactCalendarCurrentCollapsibleProps {
  tasks: Task[];
...
const CompactCalendarCurrentCollapsible: React.FC<CompactCalendarCurrentCollapsibleProps> = ({
  tasks,
  onDateSelect,
  onTaskSelect,
  className = ""
  ...
  return (
    <motion.div
      className={`compact-calendar-current-collapsible ${className}`}
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.4 }}
    >
      {/* Header Elegante con Colapso */}
...
export default CompactCalendarCurrentCollapsible;
