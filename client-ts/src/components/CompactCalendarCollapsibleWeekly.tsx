...
interface CompactCalendarCollapsibleWeeklyProps {
  tasks: Task[];
...
const CompactCalendarCollapsibleWeekly: React.FC<CompactCalendarCollapsibleWeeklyProps> = ({
  tasks,
  onDateSelect,
  onTaskSelect,
  className = ""
  ...
  return (
    <motion.div
      className={`compact-calendar-collapsible-weekly ${className}`}
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.4 }}
    >
      {/* Header Colapsable con Navegación Semanal */}
...
export default CompactCalendarCollapsibleWeekly;
