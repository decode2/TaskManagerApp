          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center space-x-3 p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900"
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  ...
                  >
                    ...
                    {/* Menu Items */}
                    <div className="py-2">
                      <button className="w-full px-4 py-2 text-left text-sm text-slate-700 dark:text-gray-100 hover:bg-slate-100/80 dark:hover:bg-slate-700/80 transition-colors duration-150">
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 text-left text-sm text-red-700 dark:text-red-300 hover:bg-red-50/80 dark:hover:bg-red-900/40 transition-colors duration-150"
                    >
                      <div className="flex items-center space-x-3">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
